...
set K 65;	#per-queue ECN marking threshold
set K_Low 65;	#The low per-port ECN marking threshold
set K_High 100;	#The high per-port ECN marking threshold
set RTT 0.0001
set DCTCP_g_ 0.0625
set ackRatio 1 
set packetSize 1460
...
set simulationTime 0.1
set throughputSamplingInterval 0.0002

set service1_senders 3
...
Queue/WF2Q set port_ecn_marking_ 1
Queue/WF2Q set mean_pktsize_ $packetSize
Queue/WF2Q set queue_thresh_ [expr $K]
Queue/WF2Q set port_low_thresh_ [expr $K_Low]
Queue/WF2Q set port_high_thresh_ [expr $K_High]
