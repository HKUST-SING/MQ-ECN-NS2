...
set K_0 80;	#The per-queue ECN marking threshold of the first queue
set K_1 80;	#The per-queue ECN marking threshold of the second queue
set W_0 1500; #The quantum/weight of the first queue
set W_1 3000; #The quantum/weight of the second queue
set marking_scheme 2
...
Queue/WRR set queue_num_ 2
Queue/WRR set mean_pktsize_ [expr $packetSize + 40]
Queue/WRR set port_thresh_ $K_port
Queue/WRR set marking_scheme_ $marking_scheme
